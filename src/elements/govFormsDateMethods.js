...
define(['common/core/exceptions',
...
], function (exceptions, exceptionsMessages, stringExtension) {

    function throwInvalidElementTypeException() {
        exceptions.throwFormError(stringExtension.format(exceptionsMessages.invalidElementTypeBinding, 'element', 'tlpDatepicker'));
    }
    ...
    var getButton = function getButton(element) {//eslint-disable-line consistent-return
        var buttonIDSelector = `#datepicker_button_${$(element).attr('id')}`;
