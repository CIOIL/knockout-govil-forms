define(['common/components/groups/FormComponent',
        ...
        'common/components/groups/contactDetailsWithAddress/resources',
    ...
    function (FormComponent, Address, ContactDetails, reflection, areaCodesDefer, resources) {//eslint-disable-line max-params
        ...
        /**
       * @class  ContactDetailsWithAddress
       ...
       */
        var ContactDetailsWithAddress = function (settings) {
        ...
        ContactDetailsWithAddress.prototype = Object.create(FormComponent.prototype);
        ContactDetailsWithAddress.prototype.constructor = ContactDetailsWithAddress;
        ContactDetailsWithAddress.defaultSettings = defaultSettings;

        return ContactDetailsWithAddress;
    });
