...
define(['common/dataServices/hebrewYearRequest'], function (hebrewYearRequest) {
    ...
    describe('hebrewYearRequest', function () {
        ...
        var fakeListFromServer = [{ 'dataCode': 5776, 'dataText': '���"�' }, { 'dataCode': 5777, 'dataText': '���"�' }, { 'dataCode': 5778, 'dataText': '���"�' }];
        ...
        describe('getListRequest', function () {
            ...
            describe('parameter setting', function () {
                it('is optional', function () {
                    expect(function () {
                        hebrewYearRequest.getListRequest();
                    }).not.toThrow();
                });
            });
            describe('logic', function () {
                ...
                it('returned value is a promise', function () {
                    ...
                    expect((typeof result === 'undefined' ? 'undefined' : _typeof(result)) === 'object').toBeTruthy();
                ...
                it('returned promise contains desired years', function (done) {
                    ...
                    request.then(function (result) {
                        ...
                        expect(result[0].dataText).toEqual('���"�');
                        expect(result[1].dataText).toEqual('���"�');
