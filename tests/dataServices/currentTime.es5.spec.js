...
define(['common/dataServices/currentTime', 'common/resources/domains', 'common/networking/ajax', 'common/core/generalAttributes', 'common/external/q', 'common/core/domReadyPromise', 'common/external/date'], function (currentTime, domains, ajax, generalAttributes, Q, domReadyPromise) {
    //eslint-disable-line
    ...
    describe('currentTime', function () {
        ...
        describe('request', function () {
            ...
            it('should return promise', function (done) {
                ...
                currentTimeRequest.then(function (response) {
                    expect(typeof response === 'undefined' ? 'undefined' : _typeof(response)).toEqual('string');
                    expect(response).toEqual(fakedTimeResponse);
                    done();
                });
            });
            it('the url of the request shuold be according to the tfssubmitactionparam in generalAttributes', function (done) {
                //todo: add validate of serverName parameter
        ...
        describe('request params', function () {
            ...
            it('serverName is optional', function () {
                ...
                expect(function () {
                    currentTime.request(productionServerName);
                }).not.toThrow();
            });
        });
