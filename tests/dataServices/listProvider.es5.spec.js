define(['common/dataServices/listProvider', 'common/networking/services', 'common/external/q'], function (listProvider, services, Q) {
    ...
    describe('listProvider - ', function () {
        ...
        describe('getList - ', function () {
            ...
            describe('correct params - ', function () {
                it('should creste request to ListProvider/GetList', function (done) {
                    var list = listProvider.getList({ listName: 'Police' });
                    list.then(function () {
                ...
                it('avaliable to add/run over settings', function (done) {
                    var list = listProvider.getList({ listName: 'Police' }, { method: 'GET', abc: 'fff' });
                    list.then(function () {
        ...
        describe('getLists - ', function () {
            ...
            describe('correct params - ', function () {
                it('should create request to ListProvider/GetLists', function (done) {
                    var list = listProvider.getLists({ paramsList: [{ listName: 'Police' }] });
                    list.then(function () {
                ...
                it('avaliable to add/run over settings', function (done) {
                    var list = listProvider.getLists({ paramsList: [{ listName: 'Police' }] }, { method: 'GET', abc: 'fff' });
                    list.then(function () {
                        expect(requestSettings.method).toEqual('GET');
                        expect(requestSettings.abc).toEqual('fff');
                        done();
        ...
        describe('getEntityBase - ', function () {
            it('missing require param listName should throw error', function () {
                expect(function () {
                    listProvider.getEntityBase({ dataCodeColumn: 'code', dataTextColumn: 'name' });
                }).toThrow();
            });
            it('missing require param dataCodeColumn should throw error', function () {
                expect(function () {
                    listProvider.getEntityBase({ listName: 'Police', dataTextColumn: 'name' });
                }).toThrowError('missing required param dataCodeColumn, listName: Police in GetAsEntityBase function (listProvider module)');
            });
            it('missing require param dataTextColumn should throw error', function () {
                expect(function () {
                    listProvider.getEntityBase({ listName: 'Police', dataCodeColumn: 'code' });
                }).toThrowError('missing required param dataTextColumn, listName: Police. in GetAsEntityBase function (listProvider module)');
            });
            describe('correct params - ', function () {
                it('should creste request to ListProvider/GetList', function (done) {
                    var list = listProvider.getEntityBase({ listName: 'Police', dataCodeColumn: 'code', dataTextColumn: 'name' });
                    list.then(function () {
                ...
                it('avaliable to add/run over settings', function (done) {
                    var list = listProvider.getEntityBase({ listName: 'Police', dataCodeColumn: 'code', dataTextColumn: 'name' }, { method: 'GET', abc: 'fff' });
                    list.then(function () {
                        expect(requestSettings.method).toEqual('GET');
                        expect(requestSettings.abc).toEqual('fff');
                        done();
        ...
        describe('getEntityBase - ', function () {
            ...
            it('missing require param listName should throw error', function () {
                expect(function () {
                    listProvider.getEntityBaseLists({ paramsList: [{ dataCodeColumn: 'code', dataTextColumn: 'name' }] });
                }).toThrow();
            });
            it('missing require param dataCodeColumn should throw error', function () {
                expect(function () {
                    listProvider.getEntityBaseLists({ paramsList: [{ listName: 'Police', dataTextColumn: 'name' }] });
                }).toThrowError('missing required param dataCodeColumn, listName: Police in GetAsEntityBaseLists function (listProvider module)');
            });
            it('missing require param dataTextColumn should throw error', function () {
                expect(function () {
            ...
            describe('correct params - ', function () {
                it('should creste request to ListProvider/getEntityBaseLists', function (done) {
                    var list = listProvider.getEntityBaseLists({ paramsList: [{ listName: 'Police', dataCodeColumn: 'code', dataTextColumn: 'name' }] });
                    list.then(function () {
                ...
                it('avaliable to add/run over settings', function (done) {
                    var list = listProvider.getEntityBaseLists({ paramsList: [{ listName: 'Police', dataCodeColumn: 'code', dataTextColumn: 'name' }] }, { method: 'GET', abc: 'fff' });
                    list.then(function () {
                        expect(requestSettings.method).toEqual('GET');
                        expect(requestSettings.abc).toEqual('fff');
                        done();
        ...
        describe('getFirstItem - ', function () {
            ...
            describe('correct params - ', function () {
                it('should creste request to ListProvider/GetList', function (done) {
                    var list = listProvider.getFirstItem({ listName: 'Police' });
                    list.then(function () {
        ...
        describe('IsExistItem - ', function () {
            ...
            describe('correct params - ', function () {
                it('should creste request to ListProvider/GetList', function (done) {
                    var list = listProvider.IsExistItem({ listName: 'Police', filters: [{}] });
                    list.then(function () {
                ...
                it('avaliable to add/run over settings', function (done) {
                    var list = listProvider.IsExistItem({ listName: 'Police', filters: [{}] }, { method: 'GET', abc: 'fff' });
                    list.then(function () {
                        expect(requestSettings.method).toEqual('GET');
                        expect(requestSettings.abc).toEqual('fff');
                        done();
