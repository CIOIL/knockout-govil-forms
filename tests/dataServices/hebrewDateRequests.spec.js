define(['common/dataServices/hebrewDateRequests', 'common/networking/services', 'common/networking/ajax'],
function (hebrewDateRequests, services, ajax) {
            ...
            describe('parameters', function () {
                describe('month', function () {
                    it('is mandatory ', function () {
                        expect(function () { hebrewDateRequests.getDays(); }).toThrow();
                    });
                    it('numeric value is valid', function (done) {
                        ...
                        expect(function () { hebrewDateRequests.getDays(3, year); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
                    });
                    ...
                    it('un-numeric string is not valid', function () {
                        expect(function () { hebrewDateRequests.getDays('aaa', year); }).toThrow();
                    });
                    it('in range 1-13 is valid', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                        expect(function () { hebrewDateRequests.getDays(1, year); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
                    });
                    it('less than 1 is not valid', function () {
                        expect(function () { hebrewDateRequests.getDays(0, year); }).toThrow();
                    });
                    it('grater than 13 is not valid', function () {
                        expect(function () { hebrewDateRequests.getDays(outOfRangeMonth, year); }).toThrow();
                    });
                });
                describe('year', function () {

                    it('is mandatory ', function () {
                        expect(function () { hebrewDateRequests.getDays(month); }).toThrow();
                    });
                    it('numeric value is valid', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                        expect(function () { hebrewDateRequests.getDays(month, year); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
                    });
                    it('numeric value by string type is valid', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                        expect(function () { hebrewDateRequests.getDays(month, '5775'); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
                    });
                    it('un-numeric string is not valid', function () {
                        expect(function () { hebrewDateRequests.getDays(month, 'aaa'); }).toThrow();
                    });
                    ...
                    it('less than 5344 is not valid', function () {
                        expect(function () { hebrewDateRequests.getDays(month, 0); }).toThrow();
                    });
                    it('grater than 5999 is not valid', function () {
                        expect(function () { hebrewDateRequests.getDays(month, outOfRangeYear); }).toThrow();
                    });
            ...
            describe('parameters', function () {
                ...
                describe('settings', function () {
                    it('is not mandatory ', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                        expect(function () { hebrewDateRequests.getMonths(year); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
        ...
        describe('getYears method', function () {
            ...
            describe('parameters', function () {
                describe('baseYear', function () {
                    it('is mandatory ', function () {
                        expect(function () { hebrewDateRequests.getYears(); }).toThrow();
                    });

                    it('numeric value is valid', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                        expect(function () { hebrewDateRequests.getYears(baseYear, numberOfYears); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
                    });
                    it('numeric value by string type is valid', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                        expect(function () { hebrewDateRequests.getYears('5775', numberOfYears); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
                    });
                    it('un-numeric string is not valid', function () {
                        expect(function () { hebrewDateRequests.getYears('aaa', numberOfYears); }).toThrow();
                    });
                    it('in range 1000-6000 is valid', function () {
                        expect(function () { hebrewDateRequests.getYears(baseYear, numberOfYears); }).not.toThrow();
                    });
                    it('less than 1000 is not valid', function () {
                        expect(function () { hebrewDateRequests.getYears(0); }).toThrow();
                    });
                    it('grater than 6000 is not valid', function () {
                        expect(function () { hebrewDateRequests.getYears(outOfRangeYear, numberOfYears); }).toThrow();
                    });

                });
                describe('numberOfYears', function () {
                    it('is mandatory ', function () {
                        expect(function () { hebrewDateRequests.getYears(baseYear); }).toThrow();
                    });
                    it('numeric value is valid', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                    ...
                    it('numeric value by string type is valid', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                        expect(function () { hebrewDateRequests.getYears(baseYear, '140'); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
                    });
                    it('un-numeric string is not valid', function () {
                        expect(function () { hebrewDateRequests.getYears(baseYear, 'aaa'); }).toThrow();
                    });
                    ...
                    it('less than 0 is not valid', function () {
                        expect(function () { hebrewDateRequests.getYears(baseYear, belowOfRangeNumberOfYears); }).toThrow();
                    });
                    it('grater than 140 is not valid', function () {
                        expect(function () { hebrewDateRequests.getYears(baseYear, outOfRangeNumberOfYears); }).toThrow();
        ...
        describe('getDate method', function () {
            ...
            describe('parameters', function () {
                describe('date', function () {
                    ...
                    it('is mandatory ', function () {
                        expect(function () { hebrewDateRequests.getDate(); }).toThrow();
                    });
                    it('Date  is valid', function (done) {
                        jasmine.getFixtures().fixturesPath = 'base/Tests/dataServices/templates';
                        loadFixtures('hebrewDateRequests.html');
                        expect(function () { hebrewDateRequests.getDate(new Date()); }).not.toThrow();
                        setTimeout(function () {
                            done();
                        }, 1);
                    });
                    ...
                    it('formatted date is not valid', function () {
                        expect(function () { hebrewDateRequests.getDate('01/10/1991'); }).toThrow();
                    });
