define(['common/components/recaptcha/recaptchaGenerator',
     'common/core/generalAttributes',
     'common/external/q'
], function (recaptchaGenerator, generalAttributes, Q) {//eslint-disable-line
    ...
    describe('recaptcha', function () {
        ...
        describe('settings', function () {
            ...
            it('widgetId is empty string', function () {
                expect(function () {
                    new recaptchaGenerator({ callback: function () { } });
                }).toThrowError('parameter widgetId is null or empty');
            });
        ...
        var generateRecaptcha = function (widgetId) {
