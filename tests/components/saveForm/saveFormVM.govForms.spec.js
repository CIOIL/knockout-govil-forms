define(['common/components/saveForm/saveFormVM',
    ...
    function (saveForm, formInformation, ajax, dialog, Q, userEventHandler, MWResponse, validateAction) {//eslint-disable-line  max-params
        var delay = 500;
        var subscriber;
        var saveSuccededFake = function () {
        ...
        var validateSucceded = function (deffer) {
            deffer.resolve();
        };
        var validateFailed = function (deffer) {
            deffer.reject();
        };
        ...
        describe('saveFormVM', function () {
            ...
            describe('invokeSaveEvent', function () {
                ...
                it('settings.fcallback is call when userBeforeSave reject promise', function (done) {
                    ...
                    saveForm.openSaveModal({ fcallback });
                    saveForm.invokeSaveEvent({});
                });
            });
