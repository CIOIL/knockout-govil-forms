...
define(['common/components/fileUpload/FileViewModel', 'common/external/q', 'common/networking/ajax', 'common/components/fileUpload/filesManager', 'common/components/dialog/dialog', 'common/components/formInformation/formInformationViewModel', 'common/resources/endpointsUrl', 'common/resources/texts/indicators', 'common/utilities/resourceFetcher'], function (File, Q, ajax, filesManager, dialog, formInformation, endpointsUrl, indicatorsTexts, resourceFetcher) {
    ...
    describe('', function () {
        ...
        it('tobe defined', function () {
            ...
            expect(typeof File === 'undefined' ? 'undefined' : _typeof(File)).toEqual('function');
        });
        ...
        describe('removeFile', function () {
            ...
            it('should not reset file if remove is not active', function () {
                spyOn(myFile, 'isRemoveActive').and.callFake(function () {
                    return false;
                });
