define(['common/core/generalAttributes', 'common/components/fileUpload/filesManager', 'common/utilities/stringExtension', 'common/components/fileUpload/validationRules', 'common/resources/texts/attachment', 'common/components/fileUpload/utilities', 'common/ko/validate/extensionRules/attachment', 'common/ko/globals/multiLanguageObservable'], function (generalAttributes, filesManager, stringExtension, validationRules) {
    //eslint-disable-line max-params

    describe('validate', function () {
        var nameRules = validationRules.name;
        var sizeRules = validationRules.size;
        describe('extensionRules', function () {
            describe('file type', function () {
                ...
                it('invalid inline extension should throw', function () {
                    expect(function () {
                        nameRules.fileType.validator('pomegranateLeaf.jpg', ['exe']);
                    }).toThrowError('this extension is not allowed according to the white list of extensions');
                });
            ...
            describe('file size', function () {
                ...
                describe('message', function () {
                    it('should return specific message if specific limit sent', function () {
