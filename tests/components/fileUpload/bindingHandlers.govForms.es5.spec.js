define(['common/components/fileUpload/FileViewModel', 'common/components/dialog/dialog', 'common/components/fileUpload/bindingHandlers'], function (File, dialog) {
    ...
    describe('file upload binding handlers', function () {
        ...
        beforeEach(function () {
            ...
            spyOn(dialog, 'alert');
            spyOn(viewModel.myFile, 'uploadFile').and.callFake(function () {
                return;
            });
        ...
        describe('fileValue init', function () {
            ...
            describe('event change', function () {
                ...
                describe('valid input', function () {
                    beforeEach(function () {
                        spyOn($.fn, 'get').and.callFake(function () {
                            return { files: [{ name: 'myFile.jpg', size: 263856, type: 'image/jpeg' }] };
                        });
                    });
                ...
                describe('invalid input', function () {
                    beforeEach(function () {
                        spyOn($.fn, 'get').and.callFake(function () {
                            return { files: [{ name: 'myFile.sln', size: 263856, type: 'image/jpeg' }] };
                        });
                    });
                ...
                describe('empty file size', function () {
                    it('should alert validation message', function () {
                        spyOn($.fn, 'get').and.callFake(function () {
                            return { files: [{ name: 'myFile.jpg', size: 0, type: 'image/jpeg' }] };
                        });
                        inputFile.trigger('change');
