define(['common/viewModels/ModularViewModel', 'common/utilities/reflection', 'common/utilities/stringExtension', 'common/resources/exeptionMessages', 'common/components/groups/FormComponent', 'common/ko/validate/extensionRules/personalDetails'],
    function (ModularViewModel, reflection, stringExtension, exceptionMessages, FormComponent) {//eslint-disable-line max-params
        ...
        describe('FormComponent base class', function () {
            ...
            describe('extendModelProperty', function () {
                ...
                it('extendModelProperty params', function () {
                    expect(function () { testComponent.extendModelProperty(); }).toThrowError(stringExtension.format(exceptionMessages.funcInvalidParams, ['extendModelProperty']));
                });
                    ...
                    describe('isModelRequired', function () {
                        ...
                        it('isModelRequired or required =conditional', function () {
                            settings = {
                                isModelRequired: false,
                                prop: {
                                    extenders: { required: { onlyIf: ko.computed(function () { return true; }) } },
                            ...
                            expect(getRule(prop.rules(), 'required').params).toBeTruthy();
                            settings = {
                                isModelRequired: ko.computed(function () { return true; }),
                                prop: {
                                    extenders: { required: false },
                                    ignore: []
                                }
