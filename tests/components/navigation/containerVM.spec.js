define(['common/components/navigation/ContainerVM', 'common/components/navigation/containersViewModel', 'common/ko/utils/tlpReset'],

function (Container, containersViewModel) {//eslint-disable-line no-unused-vars
