...
define(['common/components/navigation/containersViewModel', 'common/components/navigation/ContainerVM', 'common/infrastructureFacade/tfsMethods', 'common/viewModels/languageViewModel'],

function (containersViewModel, ContainerVM, tfsMethods, languageViewModel) {//eslint-disable-line max-params

    describe('swipe', function () {

        var delay = 500;

        var fakeSetLanguage = function (language) {
            return language;
        };
