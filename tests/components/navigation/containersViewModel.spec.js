define(['common/components/navigation/ContainerVM', 'common/components/navigation/containersViewModel', 'common/core/generalAttributes'],

function (ContainerVM, containersViewModel, generalAttributes) {//eslint-disable-line no-unused-vars
    ...
    describe('navigation', function () {
        ...
        it('should be defined', function () {
            expect(typeof containersViewModel === 'object').toBeTruthy();
            expect(typeof containersViewModel.containersList() === 'object').toBeTruthy();
        });
        ...
        describe('Containers List', function () {
            ...
            describe('navigateToContainer', () => {
                ...
                it('rejection in beforeNavigation should abort the navigation', function (done) {
                    ...
                    containersList[0].beforeNavigation = function (data) { data.deferred.reject(); };
                ...
                it('resolve in beforeNavigation should complete the navigation', function (done) {
                    containersList[0].setValidationState(resources.stateTypes.notValidated);
                    containersList[0].beforeNavigation = function (data) { data.deferred.resolve(); };
                    var navigationPromise = containersViewModel.navigateToContainer(containersList[0], containersList[1]);
                    navigationPromise.then(function () {
            ...
            describe('moveToContainer', function () {
                ...
                it('rejection in beforeNavigation should abort the navigation', function (done) {
                    ...
                    containersViewModel.currentContainer().beforeNavigation = function (data) { data.deferred.reject(); };
                    var navigationPromise = containersViewModel.moveToContainer(containersList[2]);
                ...
                it('resolve in beforeNavigation should complete the navigation', function (done) {
                    containersViewModel.currentContainer().setValidationState(resources.stateTypes.notValidated);
                    containersViewModel.currentContainer().beforeNavigation = function (data) { data.deferred.resolve(); };
                    var navigationPromise = containersViewModel.moveToContainer(containersList[2]);
                    navigationPromise.then(function () {
                        expect(containersViewModel.currentContainer()).toEqual(containersList[2]);
                        done();
            ...
            describe('getPrevContainer', function () {
                ...
                it('getPrevContainer when current.prev is not exist throw error', function () {
                    ...
                    containersViewModel.currentContainerName(containersList[2].name()); //containersViewModel.moveToContainer(containersList[2]);
                    expect(function () { containersViewModel.getPrevContainer(); }).toThrow(new Error(resources.errorMessages.containerNotFound));
                });
            ...
            describe('getNextContainer', function () {
                ...
                it('when current.next is not exist throw error', function () {
                    ...
                    containersViewModel.currentContainerName(containersList[1].name()); //containersViewModel.moveToContainer(containersList[1]);
                    expect(function () { containersViewModel.getNextContainer(); }).toThrow(new Error(resources.errorMessages.containerNotFound));
                });
                ...
                it('when current.next is not enabled throw error', function () {
                    ...
                    containersViewModel.currentContainerName(containersList[2].name()); //containersViewModel.moveToContainer(containersList[2]);
                    expect(function () { containersViewModel.getNextContainer(); }).toThrow(new Error(resources.errorMessages.containerNotEnabled));
                });
            ...
            it('getContainerIndex with error name throw error', function () {
                expect(function () { containersViewModel.getContainerIndex('customer'); }).toThrow(new Error(resources.errorMessages.containerNotFound));
            });
            describe('getContainerByName', function () {
                ...
                it('getContainerByName with does not exist name', function () {
                    expect(function () { containersViewModel.getContainerByName('notExist'); }).toThrow(new Error(resources.errorMessages.containerNotFound));
                });
            });
            ...
            it('getContainerByIndex with error index throw error', function () {
                expect(function () { containersViewModel.getContainerByIndex(4); }).toThrow(new Error(resources.errorMessages.containerNotFound));
            });
