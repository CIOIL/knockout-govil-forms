define(['common/components/helpAndInfo/helpAndInformation'],
        ...
        describe('helpAndInformation', function () {
            describe('validate params', function () {
                it('init helpAndInformation without params wont fail', function () {
                    expect(function () { helpAndInformation.initHelpAndInformationMenue({}); }).not.toThrow();
                });
                ...
                it('init helpAndInformation with empty officeInformation object fail', function () {
                    expect(function () { helpAndInformation.initHelpAndInformationMenue({officeInformation: {}}); }).toThrow();
                });
                it('init helpAndInformation with empty additionalInformation object fail', function () {
                    expect(function () { helpAndInformation.initHelpAndInformationMenue({ additionalInformation: {} }); }).toThrow();
                });
                it('init helpAndInformation with empty instructions object fail', function () {
                    expect(function () { helpAndInformation.initHelpAndInformationMenue({ instructions: {} }); }).toThrow();
                });
            });
