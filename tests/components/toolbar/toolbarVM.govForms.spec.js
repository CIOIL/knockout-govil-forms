define(['common/components/toolbar/toolbarVM',
        'common/components/helpAndInfo/helpAndInformation',
...
'common/utilities/userBrowser',
    ...
    function (toolbarVM, helpAndInfo, saveFormVM, submitAction, printAction, validateAction, Q, containersViewModel, userBrowser) {//eslint-disable-line max-params

        const helpAndInformation = helpAndInfo.initHelpAndInformationMenue({});
        let toolbar;

        describe('params', function () {
            it('initToolbarVM without toggleInformationMenue fail', function () {
                expect(function () { toolbar = toolbarVM.initToolbarVM(); }).toThrow();
            });
        ...
        describe('buttons visibility ', function () {
            describe('submit', function () {
                ...
                it('enable by computed', function () {
                    let submitEnable = ko.observable(true);
                    const settings = { submit: ko.computed(function () { return submitEnable(); }) };
            ...
            describe('print', function () {
                ...
                it('enable by computed', function () {
                    let printEnable = ko.observable(true);
                    const settings = { print: ko.computed(function () { return printEnable(); }) };
                    toolbar = toolbarVM.initToolbarVM({ toggleInformationMenue: helpAndInformation.toggleInformationMenue, toolbarButtons: settings });
                    printEnable(false);
            ...
            describe('validate', function () {
                ...
                it('enable by computed', function () {
                    let validateEnable = ko.observable(true);
                    const settings = { validate: ko.computed(function () { return validateEnable(); }) };
                    toolbar = toolbarVM.initToolbarVM({ toggleInformationMenue: helpAndInformation.toggleInformationMenue, toolbarButtons: settings });
            ...
            describe('save', function () {
                ...
                it('enable by computed', function () {
                    let saveEnable = ko.observable(true);
                    const settings = { save: ko.computed(function () { return saveEnable(); }) };
                    toolbar = toolbarVM.initToolbarVM({ toggleInformationMenue: helpAndInformation.toggleInformationMenue, toolbarButtons: settings });
                    saveEnable(false);
            ...
            describe('saveAsPDF', function () {
                ...
                it('enable by computed', function () {
                    let saveAsPDFEnable = ko.observable(true);
                    const settings = { saveAsPdf: ko.computed(function () { return saveAsPDFEnable(); }) };
                    toolbar = toolbarVM.initToolbarVM({ toggleInformationMenue: helpAndInformation.toggleInformationMenue, toolbarButtons: settings });
            ...
            describe('drawers and tabs', function () {
                describe('isTabsMode is true', function () {
                    ...
                    it('drawers enable by computed', function () {
                        containersViewModel.isTabsMode(true);
                        let changeViewEnable = ko.observable(true);
                        const settings = { changeView: ko.computed(function () { return changeViewEnable(); }) };
                        toolbar = toolbarVM.initToolbarVM({ toggleInformationMenue: helpAndInformation.toggleInformationMenue, toolbarButtons: settings });
