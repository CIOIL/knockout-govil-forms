define(['common/components/date/basePartViewModel', 'common/viewModels/ModularViewModel'],
function (BasePartViewModel, ModularViewModel) {
    describe('BasePartViewModel', function () {
        ...
        it('settings recived - unwrap isRequired', function () {
            basePartViewModel = new BasePartViewModel({ isRequired: function () { return true; }, title: 'תאריך פטירה' });
            expect(basePartViewModel.title()).toEqual('תאריך פטירה');
            expect(basePartViewModel.isRequired()).toBeTruthy();
        });
