...
define(['common/components/date/hebrew/monthViewModel', 'common/external/q'], function (MonthViewModel, Q) {
        ...
        describe('functions', function () {
                ...
                describe('invalid parameters ', function () {
                    describe('settings is undefined ', function () {
                        ...
                        it('return a promise', function () {
                            expect((typeof request === 'undefined' ? 'undefined' : _typeof(request)) === 'object').toBeTruthy();
            ...
            describe('handleRequestResult', function () {
                ...
                it('undefined parameter', function () {
                    expect(function () {
                        monthViewModel.handleRequestResult();
                    }).toThrow();
                });
            });
