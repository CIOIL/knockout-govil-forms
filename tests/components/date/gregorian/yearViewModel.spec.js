define(['common/components/date/gregorian/yearViewModel'],
    ...
    describe('YearViewModel', function () {
        ...
        describe('', function () {
            ...
            it('use setting if sent', function () {
                ...
                expect(yearViewModel.list()).toEqual([{ dataCode: 2000, dataText: '2000' },
                                                      { dataCode: 2001, dataText: '2001' },
                                                      { dataCode: 2002, dataText: '2002' }]);
            });
        ...
        describe('functions', function () {
            describe('getList', function () {
                ...
                it('without parameters - throw an error', function () {
                    expect(function () { yearViewModel.getList(); }).toThrow();
                });

                it('invalid parameters - throw exception', function () {
                    expect(function () { yearViewModel.getList('2016', '3', true); }).toThrow();
