define(['common/components/elements/FormElement',
    ...
    function (FormElement, Street) {//eslint-disable-line max-params
        ...
        describe('Street', function () {
            ...
            describe('new Street', () => {
                const cityCode = ko.observable('');
                const testStreet = new Street({ filter: cityCode });
                it('verify proper inheritence', () => {
                ...
                it('filter property should return -1 when filter in the settings is empty', () => {
                    cityCode('30');
