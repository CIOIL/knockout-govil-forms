define(['common/components/RadioGroup/radioGroup', 'common/viewModels/ModularViewModel'], function (radioGroup, ModularViewModel) {
    describe('radioGroup', function () {
        ...
        describe('RadioViewModel', function () {
            ...
            it('missing args', function () {
                expect(function () {
                    new radioGroup.RadioViewModel({ text: 'yes' });
                }).toThrowError('One or more of the parameters sent to function "code" are missing or have the wrong type');
                expect(function () {
                    new radioGroup.RadioViewModel({ code: 1 });
                }).toThrowError('One or more of the parameters sent to function "text" are missing or have the wrong type');
            });
        });
        ...
        describe('RadioGroupViewModel', function () {
            ...
            it('without radio array', function () {
                expect(function () {
                    new radioGroup.RadioGroupViewModel({});
                }).toThrowError('the parameter "radioArray" is invalid');
                expect(function () {
                    new radioGroup.RadioGroupViewModel({ radioArray: [1, 2] });
                }).toThrowError('the parameter "radioArray" is invalid');
            });
        ...
        describe('options binding - adding bindings that not defined as default radio behavior', function () {
            ...
            beforeEach(function () {
                ...
                var radioArray = [new radioGroup.RadioViewModel({ code: 1, text: 'זכר', optionsBinding: { attr: { 'disabled': addDisabledAttribute }, css: { 'first': addFirstClass, 'second': addSecondClass } } }), new radioGroup.RadioViewModel({ code: 2, text: 'נקבה' })];
