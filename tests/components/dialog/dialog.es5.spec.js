...
define(['common/components/dialog/dialog', 'common/external/q', 'common/core/formMode', 'common/viewModels/languageViewModel'], function (dialog, Q, formMode, languageViewModel) {
    ...
    var orginalDialogMethod = $.fn.dialog;
    describe('Open', function () {
        ...
        it('should be a function', function () {
            ...
            expect(_typeof(dialog.open)).toBe('function');
        });
        ...
        it('dialog by selector should open the selected element', function () {
            var selectorObject = $('#dialogSelector');
        ...
        describe('with settings', function () {
            ...
            it('contains empty selector should open messageDialog', function () {
                ...
                var dialogSelector = $('#messageDialog');
    ...
    describe('Alert', function () {
        ...
        it('should be a function', function () {
            ...
            expect(_typeof(dialog.alert)).toBe('function');
        });
        ...
        it('dialog - close function should be called and promise resolved by ok click ', function () {
            ...
            var buttons = dialog.dialogTypes(defer).alert.buttons;
            buttons[0].click();
    ...
    describe('Confirm', function () {
        ...
        it('should be a function', function () {
            ...
            expect(_typeof(dialog.confirm)).toBe('function');
        });
        ...
        it('dialog - cancel button - dialog have been called and promise resolved', function () {
            ...
            var buttons = dialog.dialogTypes(defer).confirm.buttons;
            buttons[1].click();
            expect($.fn.dialog).toHaveBeenCalledWith('close');
