define(['common/components/payments/paymentDetailsViewModel', 'common/viewModels/languageViewModel', 'common/infrastructureFacade/tfsMethods'], function (paymentDetails, languageViewModel, tfsMethods) {
