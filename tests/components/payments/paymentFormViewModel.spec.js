define(['common/components/payments/paymentFormViewModel'],
    function (paymentForm) {
        ...
        describe('createPaymentFormViewModel', function () {
            ...
            describe('settings', function () {
                it('settings is optional', function () {
                    expect(function () { paymentForm.createPaymentFormViewModel(); }).not.toThrow();
                });
        ...
        describe('callBackPayment function', function () {
            ...
            it('response is undefined - throw', function () {
                expect(function () { paymentFormVM.callBackPayment(); }).toThrow();
            });
