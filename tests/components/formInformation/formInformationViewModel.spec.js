define(['common/components/formInformation/formInformationViewModel',
...
], function (formInformationViewModel, ModularViewModel, Q, readyToRequestPromise, stringExtension, tfsMethods, currentTime, mappingManager) {//eslint-disable-line max-params
    //todo:   jsdoc
    ...
    describe('formInformationViewModel', function () {
        ...
        it('should be innherited from baseViewModel class', function () {//todo: change the test to typeOf baseViewModel
        ...
        describe('functions', function () {
            ...
            describe('isFirstLoad', function () {
                it('should return true dataModelSaver contain wasn\'t changed', function () {//todo:take to functions
                    expect(formInformationViewModel.isFirstLoad()).toBeTruthy();
                });
                it('should return false after save data in dataModelSaver', function () {//todo:take to functions
            ...
            describe('updateToCurrentDate', function () {
                ...
                var baseYear = 2015, baseMonth = 9, baseDay = 23;
                ...
                var fakedDateTimeRequest = function () {
                ...
                var fakeUnValidRequest = function () {
                    return Q.fcall(function () {
                    ...
                    it('should update with date from client', function (done) {
                        readyToRequestPromise.then().done(function () {
                            currentTime.getDateInGeneralFormatPromise().then(function () {
                                expect(formInformationViewModel.loadingDate()).
                                    toEqual(baseTime.toString(formInformationViewModel.resources.generalDateFormat));
                                done();
                            });
                        });
                    });
