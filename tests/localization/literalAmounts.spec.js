define([
    'common/localization/literalAmounts'    
],
function (literalAmounts) {
    /* eslint-disable no-magic-numbers */
    describe('literal numbers', function () {
        describe('english literal numbers', function () {          

            it('defined', function () {
                expect(typeof literalAmounts).toEqual('object');
                expect(typeof literalAmounts.convertAmount).toEqual('function');
            });
            ...
            it('correctly converts numbers < 1000', function () {
                ...
                expect(literalAmounts.convertAmount(1234,{lang:'en'})).toEqual(
                  'one thousand two hundred and thirty-four dollars'
                );
                expect(literalAmounts.convertAmount(4323,{lang:'en'})).toEqual(
                  'four thousand three hundred and twenty-three dollars'
                );
            });
            ...
            it('correctly converts numbers > 1000', function () {
                ...
                expect(literalAmounts.convertAmount(4323000,{lang:'en'})).toEqual(
                  'four million three hundred twenty-three thousand dollars'
                );
                expect(literalAmounts.convertAmount(4323055,{lang:'en'})).toEqual(
                    'four million three hundred twenty-three thousand and fifty-five dollars'
                  );
                expect(literalAmounts.convertAmount(1570025,{lang:'en'})).toEqual(
                  'one million five hundred seventy thousand and twenty-five dollars'
                );
            });

            it('correctly converts numbers > 1 000 000 000', function () {
                expect(literalAmounts.convertAmount(1000000000, { lang: 'en' })).toEqual('one billion dollars');
                expect(literalAmounts.convertAmount(2580000000,{lang:'en'})).toEqual(
                  'two billion five hundred eighty million dollars'
                );
                expect(literalAmounts.convertAmount(1000000000000, { lang: 'en' })).toEqual('one trillion dollars');
                expect(literalAmounts.convertAmount(3627000000000,{lang:'en'})).toEqual(
                 'three trillion six hundred twenty-seven billion dollars'
                );
            });
        });
        ...
        describe('hebrew literal numbers', function () {
            ...
            it('correctly converts numbers < 1000', function () {
                ...
                expect(literalAmounts.convertAmount(1234)).toEqual(
                  'אלף מאתיים ושלושים וארבעה שקלים'
                );
                expect(literalAmounts.convertAmount(4323)).toEqual(
                  'ארבעת אלפים שלש מאות ועשרים ושלושה שקלים'
                );
            });

            it('correctly converts numbers > 1000', function () {
                expect(literalAmounts.convertAmount(103000)).toEqual(
                 'מאה ושלושה אלף שקלים'
               );

                expect(literalAmounts.convertAmount(4323000)).toEqual(
                  'ארבעה מיליון שלש מאות ועשרים ושלושה אלף שקלים'
                );
                expect(literalAmounts.convertAmount(2323055)).toEqual(
                    'שני מיליון שלש מאות ועשרים ושלושה אלף וחמישים וחמישה שקלים'
                  );
                expect(literalAmounts.convertAmount(1570025)).toEqual(
                  'מיליון חמש מאות ושבעים אלף ועשרים וחמישה שקלים'
                );
            });

            it('correctly converts numbers > 1 000 000 ', function () {
                expect(literalAmounts.convertAmount(1000000000)).toEqual('מיליארד שקלים');
                expect(literalAmounts.convertAmount(2580000000)).toEqual(
                  'שני מיליארד חמש מאות ושמונים מיליון שקלים'
                );
                expect(literalAmounts.convertAmount(1000000000000)).toEqual('טריליון שקלים');
                expect(literalAmounts.convertAmount(3627000000000)).toEqual(
                  'שלושה טריליון שש מאות ועשרים ושבעה מיליארד שקלים'
                );
            });
