define([
    'common/localization/literalNumbers'    
],
function (literalNumbers) {
    ...
    describe('literal numbers', function () {
        describe('english literal numbers', function () {          
            ...
            it('correctly converts numbers < 1000', function () {
                ...
                expect(literalNumbers.convertNumber(4323,{lang:'en'})).toEqual(
            ...
            it('correctly converts numbers > 1000', function () {
                ...
                expect(literalNumbers.convertNumber(4323055,{lang:'en'})).toEqual(
                    'four million three hundred twenty-three thousand and fifty-five'
                  );
                expect(literalNumbers.convertNumber(1570025,{lang:'en'})).toEqual(
            ...
            it('correctly converts numbers > 1 000 000 000', function () {
                expect(literalNumbers.convertNumber(1000000000,{lang:'en'})).toEqual('one billion');
                expect(literalNumbers.convertNumber(2580000000,{lang:'en'})).toEqual(
                  'two billion five hundred eighty million'
                );
                expect(literalNumbers.convertNumber(1000000000000,{lang:'en'})).toEqual('one trillion');
                expect(literalNumbers.convertNumber(3627000000000,{lang:'en'})).toEqual(
        ...
        describe('hebrew literal numbers', function () {
            ...
            it('correctly converts numbers < 1000', function () {
                ...
                expect(literalNumbers.convertNumber(1234)).toEqual(
                  'אלף מאתיים ושלושים וארבעה'
                );
                expect(literalNumbers.convertNumber(4323)).toEqual(
                  'ארבעת אלפים שלש מאות ועשרים ושלושה'
                );
            });

            it('correctly converts numbers > 1000', function () {
                expect(literalNumbers.convertNumber(103000)).toEqual(
                 'מאה ושלושה אלף'
               );

                expect(literalNumbers.convertNumber(4323000)).toEqual(
                  'ארבעה מיליון שלש מאות ועשרים ושלושה אלף'
                );
                expect(literalNumbers.convertNumber(2323055)).toEqual(
                    'שני מיליון שלש מאות ועשרים ושלושה אלף וחמישים וחמישה'
                  );
                expect(literalNumbers.convertNumber(1570025)).toEqual(
                  'מיליון חמש מאות ושבעים אלף ועשרים וחמישה'
                );
            });

            it('correctly converts numbers > 1 000 000 ', function () {
                expect(literalNumbers.convertNumber(1000000000)).toEqual('מיליארד');
                expect(literalNumbers.convertNumber(2580000000)).toEqual(
                  'שני מיליארד חמש מאות ושמונים מיליון'
                );
                expect(literalNumbers.convertNumber(1000000000000)).toEqual('טריליון');
                expect(literalNumbers.convertNumber(3627000000000)).toEqual(
                  'שלושה טריליון שש מאות ועשרים ושבעה מיליארד'
                );
            });
