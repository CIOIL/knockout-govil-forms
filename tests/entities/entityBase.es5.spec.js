define(['common/entities/entityBase', 'common/external/q'], function (entityBase, Q) {
    ...
    describe('getTextByCode', function () {
        describe('EntityBase', function () {
            var array = [new entityBase.EntityBase({ key: 1, value: 'צהוב' }), new entityBase.EntityBase({ key: 2, value: 'ירוק' }), new entityBase.EntityBase({ key: 3, value: 'אדום' }), new entityBase.EntityBase({ key: 3, value: 'ירוק' }), new entityBase.EntityBase({ key: '5', value: 'שחור' })];
            ...
            it('test empty array', function () {
                expect(function () {
                    entityBase.utils.getTextByCode([], 3);
                }).toThrowError(invalidError);
            });

            it('test undefined value (no second parameter)', function () {
                expect(function () {
                    entityBase.utils.getTextByCode();
                }).toThrowError(invalidError);
            });
    ...
    describe('getCodeByText', function () {
        ...
        describe('EntityBase', function () {
            var array = [new entityBase.EntityBase({ key: 1, value: 'צהוב' }), new entityBase.EntityBase({ key: 2, value: 'ירוק' }), new entityBase.EntityBase({ key: 3, value: 'אדום' }), new entityBase.EntityBase({ key: 3, value: 'ירוק' }), new entityBase.EntityBase({ key: '5', value: 5 })];
            ...
            it('test empty array', function () {
                expect(function () {
                    entityBase.utils.getCodeByText([], 'צהוב');
                }).toThrowError(invalidError);
            });

            it('test undefined value (no second parameter)', function () {
                expect(function () {
                    entityBase.utils.getCodeByText();
                }).toThrowError(invalidError);
            });
    ...
    describe('invalid type', function () {
        ...
        it('getCodeByText', function () {
            var array = ['ירוק', 'צהוב'];
            expect(function () {
                entityBase.utils.getCodeByText(array, 'צהוב');
            }).toThrowError(error);
        });
        it('getCodeByText', function () {
            var array = [1, 2];
            expect(function () {
                entityBase.utils.getTextByCode(array, 1);
            }).toThrowError(error);
        });
    });
