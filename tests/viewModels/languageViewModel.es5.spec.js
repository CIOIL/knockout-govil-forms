...
define(['common/infrastructureFacade/tfsMethods', 'common/viewModels/languageViewModel', 'common/utilities/stringExtension', 'common/resources/exeptionMessages', 'common/core/formMode'], function (infsMethods, languageViewModel, stringExtension, exceptionsMessages, formMode) {
    //eslint-disable-line
    ...
    describe('languageViewModel', function () {
        ...
        describe('languagesList', function () {
            ...
            describe('update languagesList should update validLanguages & defaultLanguages', function () {
                var languagesListArray = [{ longName: 'newLanguage', shortName: 'aa', text: 'newLanguage', defaultLanguage: 'english', dir: 'ltr' }];
        ...
        describe('change language dynamically', function myfunction() {
            ...
            it('should change agat language', function () {
                var lastFormMode = formMode.mode();
        ...
        describe('getLanguageByLongName', function () {
            ...
            it('should be function', function () {
                expect(_typeof(languageViewModel.getLanguageByLongName)).toEqual('function');
            });

            describe('return object by params', function () {
                beforeEach(function () {
                    languageViewModel.languagesList = ko.observableArray([{ longName: 'english', shortName: 'en', text: 'English', defaultLanguage: 'english', dir: 'ltr' }, { longName: 'hebrew', shortName: 'he', text: 'עברית', defaultLanguage: 'hebrew', dir: 'rtl' }]);
                });
                ...
                it('return type of object if language exist in languageViewModel.languagesList', function () {
                    expect(_typeof(languageViewModel.getLanguageByLongName('english'))).toEqual('object');
                });
        ...
        describe('getDefaultLanguage', function () {
            it('should be function', function () {
                expect(_typeof(languageViewModel.getDefaultLanguage)).toEqual('function');
            });

            describe('return default language or "english"', function () {
                beforeEach(function () {
                    languageViewModel.languagesList = ko.observableArray([{ longName: 'arabic', shortName: '', text: 'العربي', defaultLanguage: 'english', dir: 'rtl' }, { longName: 'russian', shortName: 'ru', text: 'русский', defaultLanguage: 'english', dir: 'ltr' }, { longName: 'amharic' }]);
                });
        ...
        describe('get Available Languages', function myfunction() {
            ...
            it('should be function', function () {
                expect(_typeof(languageViewModel.getAvailableLanguages)).toEqual('function');
            });
            ...
            describe('params', function () {
                ...
                it('settings parameter should be array', function () {
                    var settings = 1;
                    expect(function () {
                        languageViewModel.getAvailableLanguages(settings);
                    }).toThrowError(stringExtension.format(exceptionsMessages.invalidParam, settings));
                });
            });
            ...
            describe('return params', function () {
                ...
                it('should throw error for not valid language', function () {
                    ...
                    expect(function () {
                        languageViewModel.getAvailableLanguages(arrayLanguages);
                    }).toThrowError(stringExtension.format(exceptionsMessages.languageNameIsNotValid, 'xxx'));
                });
        ...
        describe('getShortName', function () {
            ...
            it('should be function', function () {
                expect(_typeof(languageViewModel.getShortName)).toEqual('function');
            });
