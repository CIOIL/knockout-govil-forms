...
define(['common/viewModels/ModularViewModel', 'common/core/mappingManager'], function (ModularViewModel, mappingManager) {
    ...
    describe('ModularViewModel', function () {
                ...
                describe('make public model properties', function () {
                    ...
                    beforeEach(function () {
                        model = {
                            ...
                            next: new ModularViewModel(new ModularViewModel({ heigth: ko.observable() }))
                        };
                        viewModel = new ModularViewModel(model);
                    });
        ...
        describe('innerite', function () {
            var PersonVM = function PersonVM() {
                var model = {
                    userFirstName: ko.observable(''),
                    userLastName: ko.observable(''),
                    idnum: ko.observable('')
