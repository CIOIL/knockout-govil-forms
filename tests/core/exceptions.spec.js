define(['common/core/exceptions', 'common/configuration/globalGeneralAttributes'], function (exceptions, generalAttributes) { //eslint-disable-line no-unused-vars
    ...
    describe('formExceptions', function () {
        ...
        it('throwFormError should return an Error object', function () {          
            expect(function () { exceptions.throwFormError('invalid data'); }).toThrowError(exceptions.FormError);
        });

        it('throwFormError should return an Error object with the specified message', function () {            
            expect(function () { exceptions.throwFormError('invalid data'); }).toThrowError('invalid data');
        });
        ...
        describe('alert error only during development', function () {
            ...
            it(' in debug mode', function () {
                expect(function () { exceptions.throwFormError(message, 'debug'); }).toThrow();
            ...
            it(' not in debug mode', function () {
                ...
                expect(function () { exceptions.throwFormError(message,'release'); }).toThrow();
            ...
            it(' default behaviour - no mode is sent', function () {
                ...
                expect(function () { exceptions.throwFormError(message); }).toThrow();
