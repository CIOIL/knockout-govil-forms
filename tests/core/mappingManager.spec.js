...
define(['common/core/mappingManager', 'common/resources/exeptionMessages', 'common/utilities/stringExtension'],
 function (mappingManager, exeptionMessages, stringExtension) {//eslint-disable-line max-params
     ...
     describe('mappingManager', function () {
         ...
         describe('update', function () {
             ...
             it('should not update exits rules', function () {
                 ...
                 mappingManager.update(mappingRules);
                 expect(function () { mappingManager.update(anotherRule); }).toThrowError();
         ...
         describe('utils', function () {
             describe('create', function () {
                 ...
                 it('data and type are mandatory', function () {
                     expect(function () { mappingManager.utils.create(); }).toThrowError(stringExtension.format(exeptionMessages.invalidElementTypeParam, 'data', 'object'));
                 });
                 it('data and type are mandatory', function () {
                     var data = {};
                     expect(function () { mappingManager.utils.create(data); }).toThrowError(stringExtension.format(exeptionMessages.invalidElementTypeParam, 'type', 'constructor'));
                 });
                 ...
                 it('should use mappingRule property of the instance if exits', function () {
                     var House = function () {
                         ...
                         self.rooms = ko.observable();
                         self.doorColor = ko.observable('');
                         self.getMappingRules = function () { return { ignore: ['doorColor'] }; };
                     };
