...
function (biztalkJsonHandler, tfsMethods, indicators, resourceFetcher, stringExtension) {//eslint-disable-line max-params 
    ...
    describe('biztalkJsonHandler', function () {
        ...
        describe('getMessageByResponse', function () {
            ...
            describe('when async sending success', function () {
                var biztalkResponse = '{"ProjectNickName": "xxx@test.gov.il","StageStatus": "UserToOffice","ResponseCode": 0,"MailToUser": {"ReasonCode": 0,"ReasonText": "", "TaskStatus": 1},"updateStageStatus": { "ReasonCode": 0, "ReasonText": "","TaskStatus": 1}}';
            ...
            describe('when sending is not unique', function () {
                var biztalkResponse = '{"ProjectNickName": "xxx@test.gov.il","StageStatus": "UserToOffice","ResponseCode": 7 }';
        ...
        describe('isSuccessTask', function () {
            ...
            it('should return true when task success', function () {
                ...
                var biztalkJsonResponse = { 'ProjectNickName': 'xxx@test.gov.il', 'StageStatus': 'UserToOffice', 'ResponseCode': 0, 'MailToUser': { 'ReasonCode': 0, 'ReasonText': '', 'TaskStatus': 1 }, 'updateStageStatus': { 'ReasonCode': 0, 'ReasonText': '', 'TaskStatus': 1 } };
            ...
            it('should return false when task failed', function () {
                var biztalkResponse = '{"ProjectNickName": "xxx@test.gov.il","StageStatus": "UserToOffice","ResponseCode": 0,"MailToUser": {"ReasonCode": 0,"ReasonText": "", "TaskStatus": 0},"updateStageStatus": { "ReasonCode": 0, "ReasonText": "","TaskStatus": 1}}';
                expect(biztalkJsonHandler.isSuccessTask('MailToUser', biztalkResponse)).not.toBeTruthy();

                var biztalkJsonResponse = { 'ProjectNickName': 'xxx@test.gov.il', 'StageStatus': 'UserToOffice', 'ResponseCode': 0, 'MailToUser': { 'ReasonCode': 0, 'ReasonText': '', 'TaskStatus': 0 }, 'updateStageStatus': { 'ReasonCode': 0, 'ReasonText': '', 'TaskStatus': 1 } };
        ...
        describe('isFailedTask', function () {
            ...
            it('should return false when task success or aplicative error', function () {
                ...
                var biztalkResponse2 = '{"ProjectNickName": "xxx@test.gov.il","StageStatus": "UserToOffice","ResponseCode": 0,"MailToUser": {"ReasonCode": 0,"ReasonText": "", "TaskStatus": 6},"updateStageStatus": { "ReasonCode": 0, "ReasonText": "","TaskStatus": 1}}';
                expect(biztalkJsonHandler.isFailedTask('MailToUser', biztalkResponse2)).not.toBeTruthy();

                var biztalkJsonResponse = {'ProjectNickName': 'xxx@test.gov.il','StageStatus': 'UserToOffice','ResponseCode': 0,'MailToUser': {'ReasonCode': 0,'ReasonText': '', 'TaskStatus': 6},'updateStageStatus': { 'ReasonCode': 0, 'ReasonText': '','TaskStatus': 1}};
        ...
        describe('isApplicativeErrorTask', function () {
            ...
            it('should return true when task failed with applicative error', function () {
                var biztalkResponse = '{"ProjectNickName": "xxx@test.gov.il","StageStatus": "UserToOffice","ResponseCode": 0,"MailToUser": {"ReasonCode": 0,"ReasonText": "", "TaskStatus": 6},"updateStageStatus": { "ReasonCode": 0, "ReasonText": "","TaskStatus": 1}}';
            ...
            it('should return false when task failed or success', function () {
                ...
                var biztalkResponse2 = '{"ProjectNickName": "xxx@test.gov.il","StageStatus": "UserToOffice","ResponseCode": 0,"MailToUser": {"ReasonCode": 0,"ReasonText": "", "TaskStatus": 0},"updateStageStatus": { "ReasonCode": 0, "ReasonText": "","TaskStatus": 1}}';
