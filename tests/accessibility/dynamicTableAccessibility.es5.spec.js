...
define(['common/ko/fn/config', 'common/elements/dynamicTable', 'common/ko/bindingHandlers/accessibility', 'common/ko/bindingHandlers/checkbox'], function () {
    ...
    describe('Dynamic table', function () {
        ...
        describe('accessibility input', function () {
            ...
            it('throw an error when input not found in two traversing hierarchies', function (done) {
                setTimeout(function () {
                    expect(function () {
                        ko.bindingHandlers.accessibility.init($('[for="ID"]'.get(1)));
                    }).toThrow();
                    done();
                }, delay);
            });
        ...
        var notFound = -1,
            ...
            lbl,
            lblArray;
        var findMyLabel = function findMyLabel(element) {
