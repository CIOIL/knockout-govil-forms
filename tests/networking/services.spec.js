    ...
    describe('services', function () {
        ...
        describe('govServiceListRequest method', function () {
            ...
            describe('parameters', function () {
                ...
                it('settings object is mandatory ', function () {
                    expect(function () { services.govServiceListRequest().toThrow(); });
                });

                it('settings must be an object', function () {
                    expect(function () { services.govServiceListRequest('aaa').toThrow(); });
                });

                it('route is mandatory ', function () {
                    expect(function () { services.webServiceListRequest({ method: 'POST' }).toThrow(); });
                });
                ...
                it('only route is mandatory ', function (done) {
                    ...
                    expect(function () { services.govServiceListRequest({ route: route }); }).not.toThrow();
                    setTimeout(function () {
                        done();
                    }, 1);
                });
            ...
            describe('logic', function () {
                ...
                it('serverName received', function (done) {
                    ...
                    domReadyPromise.promise
                  .then(function (response) { result = response; })//eslint-disable-line
                      .done(function () {
                ...
                it('invalid serverName received throw an error', function () {
                    ...
                    expect(function () { services.govServiceListRequest(settings).toThrow(); });
                });
        ...
        describe('webServiceListRequest method', function () {
            ...
            describe('parameters', function () {
                ...
                it('settings object is mandatory ', function () {
                    expect(function () { services.webServiceListRequest().toThrow(); });
                });

                it('settings must be an object', function () {
                    expect(function () { services.webServiceListRequest('aaa').toThrow(); });
                });
                ...
                it('only route is mandatory ', function (done) {
                    jasmine.getFixtures().fixturesPath = 'base/Tests/networking/templates';
                    loadFixtures('services.html');
                    expect(function () { services.webServiceListRequest({ route: route }); }).not.toThrow();
                    setTimeout(function () {
                        done();
                    }, 1);
                });
