define(['common/ko/globals/defferedObservable', 'common/external/q'],
function (defferedObservable, Q) {
    describe('ko.defferedObservable', function () {
        ...
        describe('parameters', function () {
            ...
            it('settings cant be undefined', function () {
                expect(function () { ko.defferedObservable(); }).toThrowError('the parameter "settings" is undefined');
            });
            ...
            it('settings.defferd - undefined is invalid', function () {
                expect(function () { ko.defferedObservable({}); }).toThrowError('the parameter "settings.deferred" is invalid');
            });
            it('settings.defferd - empty object is invalid', function () {
                expect(function () { ko.defferedObservable({ deferred: {} }); }).toThrowError('the parameter "settings.deferred" is invalid');
            });
            it('settings.defferd - string is invalid', function () {
                expect(function () { ko.defferedObservable({ deferred: 'Hi' }); }).toThrowError('the parameter "settings.deferred" is invalid');
            });
        });
