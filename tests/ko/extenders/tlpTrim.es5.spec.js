define(['common/ko/extenders/tlpTrim'], function (tlpTrim) {
    ...
    describe('tlpTrim extender', function () {
        ...
        describe('notify subscribers', function () {
            ...
            it('should not notify subscribers when the value was not changed', function () {
                //spec deactivated due to changes to support clearAfterValidation
