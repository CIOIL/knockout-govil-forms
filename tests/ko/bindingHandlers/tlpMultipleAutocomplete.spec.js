define(['common/core/exceptions',
        ...
        'common/ko/bindingHandlers/tlpMultipleAutocomplete'
], function (formExceptions, services, Q, fillList, selectItem, entities, autocompleteUtils) {//eslint-disable-line
    ...
    describe('tlpMultipleAutocomplete', function () {
        ...
        const delay = 1000;
        const customCallback = function (deffer) {
