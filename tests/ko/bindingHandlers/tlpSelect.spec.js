...
function (entityBase) {
    ...
    beforeEach(function () {
        var list = [{ 'dataCode': '1', 'dataText': 'משרד הרווחה' },
                    { 'dataCode': '2', 'dataText': 'משרד החינוך' },
                    { 'dataCode': '3', 'dataText': 'משרד הבריאות' },
                    { 'dataCode': '4', 'dataText': 'משרד הקליטה' },
                    { 'dataCode': '5', 'dataText': 'משרד לביטחון פנים' },
                    { 'dataCode': '6', 'dataText': 'משרד התמת' }];
    ...
    describe('bindingHandler tlpSelect', function () {
        ...
        describe('valid valueAccessor', function () {
            ...
            beforeEach(function () {  // TODO: beforeAll??
    ...
    describe('bindingHandler selectedObject', function () {
        ...
        it('force to select value from options', function () { // TODO:rename to:  select value not from options is not allowed??
