...
function (tlpAttachment, stringExtension, attachmentMethods, tfsMethods, resourceFetcher, infrastructureEnums, languageViewModel) {//eslint-disable-line 
        ...
        beforeAll(function () {
            ...
            disableAttachment = function () {
                return {
                    ...
                    disableAttachmentFunction: function () {
                        return false;
                    },
