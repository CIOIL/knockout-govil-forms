define(['common/entities/entityBase', 'common/networking/services', 'common/external/q', 'common/core/exceptions', 'common/entities/entityBase', 'common/ko/bindingHandlers/tlpBindList', 'common/ko/bindingHandlers/tlpLookUp'], function (entities, services, Q, formExceptions, entityBase) {
    //eslint-disable-line
    var viewModel;
    var getViewModel;
    describe('tlpBindList', function () {
        ...
        describe('loadListTable', function () {
            beforeEach(function () {
                ...
                var SubjectsList = function SubjectsList(setting) {
                    var self = this;
                    var model = {
                ...
                getViewModel = function getViewModel(loadListparams, functionName) {
                    ...
                    var loadListCallback = function loadListCallback(deffer) {
