...
define(['common/ko/bindingHandlers/tlpLookUp', 'common/entities/entityBase'], function (tlpLookUp, entityBase) {
    ...
    describe('tlpLookUp', function () {
        ...
        describe('select', function () {
            ...
            it('options on the select ', function () {
                ...
                viewModel.streetList([new entityBase.EntityBase('01', 'יפו'), new entityBase.EntityBase('02', 'בר אילן'), new entityBase.EntityBase('03', 'ירמיהו')]);
                ko.applyBindingsToNode(street.get(0), streetBinding);
