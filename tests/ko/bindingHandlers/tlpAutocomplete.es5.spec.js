define(['common/core/exceptions', 'common/networking/services', 'common/external/q', 'common/ko/bindingHandlers/multipleSelect/fillList', 'common/entities/entityBase', 'common/external/jquery-ui', 'common/ko/bindingHandlers/tlpAutocomplete'], function (formExceptions, services, Q, fillList, entities) {
    //eslint-disable-line
    ...
    describe('tlpAutocomplete', function () {
        ...
        var listAccessor = ko.observableArray([{ 'RowNumber': 1, 'NUM': '1', 'Subject': 'משטרת ישראל', 'Sub_Subject': 'גיוס/התנדבות', 'ID_Required': '1', 'Num_Sub_Subject': '1' }, { 'RowNumber': 2, 'NUM': '1', 'Subject': 'משטרת ישראל', 'Sub_Subject': 'דוחות תעבורה', 'ID_Required': '0', 'Num_Sub_Subject': '2' }]);
