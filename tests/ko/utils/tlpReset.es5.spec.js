...
define(['common/ko/utils/tlpReset', 'common/ko/validate/utilities/phoneMethods', 'common/ko/globals/defferedObservable'], function (tlpReset, phoneMethods) {
    ...
    describe('Reset View Model', function () {
        ...
        var viewModel = function () {
            ...
            vm.model = {
                ...
                contactList: ko.observableArray([new Contact({ type: 'תייר', identityNumber: '44444444', name: 'qwe' }), new Contact({ type: 'תייר', identityNumber: '111111111', name: 'abc' }), new Contact({ type: 'עולה חדש', identityNumber: '2222222222', name: 'zxc' })]),
            ...
            describe('observable array with observables values', function () {
                ...
                describe('ignore', function () {
                    beforeEach(function () {
                        ...
                        viewModel.contactList.push(new Contact({ type: 'תייר', identityNumber: '44444444', name: 'qwe' }), new Contact({ type: 'יפה', identityNumber: '22222222', name: 'noa' }));
                    });
                ...
                describe('minLength', function () {
                    it('length array with min length bigger than 1', function () {
                        viewModel.contactListMinLength.push(new Contact({ type: 'תייר', identityNumber: '111111111', name: 'abc' }), new Contact({ type: 'עולה חדש', identityNumber: '2222222222', name: 'zxc' }));
                ...
                describe('allowEmptyTable', function () {
                    it('length array with positive allowEmptyTable', function () {
                        viewModel.contactListAllowEmpty.push(new Contact({ type: 'תייר', identityNumber: '111111111', name: 'abc' }), new Contact({ type: 'עולה חדש', identityNumber: '2222222222', name: 'zxc' }));
                ...
                describe('minLength with allowEmptyTable', function () {
                    it('minLength = 0 & allowEmptyTable = true', function () {
                        viewModel.contactList.push(new Contact({ type: 'תייר', identityNumber: '111111111', name: 'abc' }), new Contact({ type: 'עולה חדש', identityNumber: '2222222222', name: 'zxc' }));
        ...
        describe('with all types', function () {
            ...
            it('function', function () {
                expect(_typeof(viewModel.resetObj.abc)).toEqual('function');
            });
        ...
        describe('ignore', function () {
            describe('params and public property', function () {
                ...
                it('invalid ignore param', function () {
                    expect(function () {
                        ko.utils.tlpReset.resetModel(viewModel, viewModel.abc, viewModel.def);
