...
define(['common/core/applyBindingsCompletedPromise', 'common/ko/fn/afterLoadSubscribe'], function (applyBindingsCompletedPromise) {
    describe('fn afterLoadSubscribe', function () {
        ...
        it('should create the afterLoadSubscribe as function', function () {
            expect(_typeof(ko.observable().afterLoadSubscribe)).toBe('function');
        });

        it('should return ko subscription', function () {
            var subscription = ko.observable().afterLoadSubscribe(function () {});
        ...
        describe('set subscribe function', function () {
            ...
            beforeEach(function () {
                ...
                observable.afterLoadSubscribe(function () {}, context, 'beforeChange');
            });
