define(['common/ko/fn/conditionalSubscribe',
    'common/resources/exeptionMessages',
    'common/utilities/stringExtension'],
     function (conditionalSubscribe, exeptionMessages, stringExtension) {
         describe('fn conditionalSubscribe', function () {
             ...
             it('should create the conditionalSubscribe on ko.subscribable', function () {
                 ...
                 expect(ko.computed(() => { }).conditionalSubscribe).toBeDefined();
                 expect(ko.observableArray().conditionalSubscribe).toBeDefined();
             });

             it('should create the conditionalSubscribe as function', function () {
                 expect(typeof ko.observable().conditionalSubscribe).toBe('function');
             });

             it('should return ko subscription', function () {
                 var subscription = ko.observable().conditionalSubscribe(() => { });
             ...
             it('should throw exeption if condition parameter is not a function', function () {
                 expect(function () { ko.observable().conditionalSubscribe(true, () => {}); })
             ...
             describe('set subscribe function', function () {
                 ...
                 beforeEach(function () {
                     ...
                     observable.conditionalSubscribe(() => { }, () => { }, context, 'beforeChange');
                 });
             ...
             describe('manage subscription according to condition function parameter', function () {
                 var boolean, observable= ko.observable();
                 var functionParams = {
                     callback () { },
