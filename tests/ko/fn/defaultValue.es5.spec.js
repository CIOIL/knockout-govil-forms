...
define(['common/ko/fn/defaultValue', 'common/external/q', 'common/ko/globals/defferedObservable'], function (defaultValue, Q) {
    ...
    describe('fn  defaultValue', function () {
        ...
        it('should create the defaultValue as function', function () {
            expect(_typeof(ko.observable().defaultValue)).toBe('function');
        });
