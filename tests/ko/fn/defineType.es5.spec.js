...
define(['common/ko/fn/defineType', 'common/external/q', 'common/ko/globals/defferedObservable'], function (defaultValue, Q) {
    ...
    describe('fn defineType', function () {
        ...
        it('should create the defineType as function', function () {
            expect(_typeof(ko.observable().defineType)).toBe('function');
        });
