...
define(['common/utilities/stringExtension', 'common/ko/validate/koValidationSpecMatchers', 'common/resources/texts/number', 'common/resources/exeptionMessages', 'common/ko/validate/extensionRules/number', 'common/ko/globals/multiLanguageObservable'], function (stringExtension, matchers, resources) {
    //eslint-disable-line max-params
    var messages = ko.multiLanguageObservable({ resource: resources });

    var hasRule = function hasRule(rules, ruleName) {
        ...
        describe('extensionRules Number', function () {
            ...
            describe('decimalWithParam', function () {
                ...
                it('value valid and not sent beforePoint', function () {
                    expect(function () {
                        testObj.extend({ decimalWithParam: { afterPoint: '2' } });testObj('151');
                    }).toThrow();
                });
                it('value valid and not sent afterPoint', function () {
                    expect(function () {
                        testObj.extend({ decimalWithParam: { beforePoint: '2' } });testObj('151');
                    }).toThrow();
                });
                it('Parameters beforePoint and afterPoint  null', function () {
                    expect(function () {
                        testObj.extend({ decimalWithParam: { beforePoint: null, afterPoint: null } });testObj('2');
                    }).toThrow();
                    //expect(testObj).observableIsValid();
                });
            ...
            describe('range', function () {
                ...
                it('value valid and dont send min', function () {
                    expect(function () {
                        testObj.extend({ range: { max: 9 } });testObj(5);
                    }).toThrow();
                });
                it('value valid and dont send max', function () {
                    expect(function () {
                        testObj.extend({ range: { min: 1 } });testObj(5);
                    }).toThrow();
                });
                ...
                it('max & min as computed number value ', function () {
                    var maxComputed = ko.computed(function () {
                        return '10';
                    });
                ...
                it('max as observable not number ', function () {
                    expect(function () {
                        testObj.extend({ range: { min: 3, max: ko.observable('abc') } });
                    }).toThrow();
                });
            });
