define(['common/utilities/reflection',
    ...
    function (reflection, stringExtension, matchers, AddressTexts, basicTexts, languageTexts) {//eslint-disable-line max-params
            ...
            describe('extensionRules Address', function () {
                ...
                describe('zipCode', function () {
                    ...
                    it('relevant rules applied', function () {
                        ...
                        expect(ko.utils.arrayFirst(testObj.rules, function (item) { return item.rule === 'integer'; })
                        ).toBeDefined();
                    });
