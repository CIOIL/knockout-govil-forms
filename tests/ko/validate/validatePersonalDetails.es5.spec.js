...
define(['common/utilities/reflection', 'common/ko/validate/koValidationSpecMatchers', 'common/utilities/stringExtension', 'common/resources/texts/personalDetails', 'common/resources/texts/basicValidation', 'common/resources/texts/language', 'common/components/formInformation/formInformationViewModel', 'common/infrastructureFacade/tfsMethods', 'common/ko/validate/extensionRules/personalDetails', 'common/ko/globals/multiLanguageObservable'], function (reflection, matchers, stringExtension, personalDetailsTexts, basicTexts, languageTexts, formInformation, tfsMethods) {
        ...
        describe('extensionRules PersonalDetails', function () {
            ...
            describe('idNum', function () {
                ...
                it('all id rules applied', function () {
                    ...
                    expect(ko.utils.arrayFirst(testObj.rules, function (item) {
                        return item.rule === 'idNumOrPassportRule';
                    })).toBeDefined();
                });
                it('value undefined, null or empty', function () {
                    testObj(undefined);
            ...
            describe('soleTrader', function () {
                ...
                it('all id rules applied', function () {
                    ...
                    expect(ko.utils.arrayFirst(testObj.rules, function (item) {
                        return item.rule === 'soleTraderOrPassportRule';
                    })).toBeDefined();
                });
                it('value undefined, null or empty', function () {
                    testObj(undefined);
