...
define(['common/ko/validate/utilities/paramsFactories', 'common/resources/exeptionMessages', 'common/utilities/stringExtension', 'common/ko/globals/multiLanguageObservable'], function (createParamsFactories, exeptionMessages, stringExtension) {
    ...
    describe('validate', function () {
        describe('createParamsFactories', function () {
            ...
            it('verify existence', function () {
                ...
                expect(typeof createParamsFactories === 'undefined' ? 'undefined' : _typeof(createParamsFactories)).toEqual('function');
            });
            ...
            describe('validationMessageFactory', function () {
                ...
                it('if params does not contain message returns message[validationRule]', function () {
                    ...
                    expect(typeof message === 'undefined' ? 'undefined' : _typeof(message)).toEqual('function');
            ...
            describe('validationParamsFactory', function () {
                ...
                it('if params contains message returns params.message', function () {
                    ...
                    expect(_typeof(params.message)).toEqual('function');
