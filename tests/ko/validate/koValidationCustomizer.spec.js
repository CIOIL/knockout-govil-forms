define(['common/components/formInformation/formInformationViewModel',
...
], function (formInformation, stringExtension) {

    var viewModel, isMultiLanguageMock = ko.observable(true), messageSpan;
    ...
    describe('ko validation customizer', function () {
        ...
        beforeEach(function () {
            ...
            spyOn(formInformation, 'isMultiLanguage').and.callFake(() => isMultiLanguageMock());
