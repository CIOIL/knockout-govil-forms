...
define(['common/utilities/stringExtension', 'common/resources/exeptionMessages', 'common/ko/validate/koValidationSpecMatchers', 'common/resources/texts/basicValidation', 'common/ko/validate/extensionRules/general', 'common/ko/globals/multiLanguageObservable'], function (stringExtension, exceptionMessages, matchers, resources) {
            ...
            describe('notEqual', function () {
                ...
                describe('conditional validation', function () {
                    ...
                    it('rule with condition', function () {
                        var condition = ko.observable();
                        var conditionalTestObj = ko.observable().extend({ notEqual: { params: 'notEqual', onlyIf: condition } });
                        expect(_typeof(getRule(conditionalTestObj.rules, 'notEqual').condition)).toBe('function');
