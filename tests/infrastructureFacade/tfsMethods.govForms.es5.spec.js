...
define(['common/infrastructureFacade/tfsMethods', 'common/infrastructureFacade/govFormMethods', 'common/resources/infrastructureEnums', 'common/core/exceptions', 'common/resources/exeptionMessages', 'common/core/language', 'common/elements/selectMethods', 'common/components/dialog/dialog', 'common/utilities/userBrowser', 'common/external/q'], function (tfsMethods, govformMethods, infrastructureEnum, formExceptions, exceptionsMessages, language, selectMethods, dialog, userBrowser, Q) {
    ...
    describe('Test global methods', function () {
        ...
        describe('"TFS" methods', function () {
            ...
            it('not supported methods should throw', function () {
                expect(function () {
                    tfsMethods.ajaxRequest();
                }).toThrowError();
                expect(function () {
                    tfsMethods.callServer();
                }).toThrowError();
                expect(function () {
                    tfsMethods.lookup.doBind();
                }).toThrowError();
                expect(function () {
                    tfsMethods.getElementById();
                }).toThrowError();
                expect(function () {
                    tfsMethods.getElementsByName();
                }).toThrowError();
                expect(function () {
                    tfsMethods.getValue();
                }).toThrowError();
                expect(function () {
                    tfsMethods.importData();
                }).toThrowError();
                expect(function () {
                    tfsMethods.lock();
                }).toThrowError();
                ...
                expect(function () {
                    tfsMethods.AgatToolbar.submitFormSuccessCallbackHandler();
                }).toThrowError();
                expect(function () {
                    tfsMethods.AgatToolbar.saveFormAsPDF();
                }).toThrowError();
                expect(function () {
                    tfsMethods.AgatToolbar.printForm();
                }).toThrowError();
                expect(function () {
                    tfsMethods.AgatXML.getXML();
                }).toThrowError();
                expect(function () {
                    tfsMethods.AgatTables.clearTable();
                }).toThrowError();
                expect(function () {
                    AgatEngine.setFormLanguage.getXML();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attributes.getElementAction();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attributes.setElementAction();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attributes.getElementType();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attributes.getName();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attributes.setElementUploaded();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attachment.getTotalAttachmentsSize();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attachment.formAllAttachmentsTotalSize();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attachment.clearAttachment();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attachment.viewAttachment();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attachment.getAttachmentInfo();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attachment.getAttachmentsUniqueNames();
                }).toThrowError();
                expect(function () {
                    tfsMethods.attachment.isAttachmentInput();
                }).toThrowError();
                expect(function () {
                    tfsMethods.dialog.openDialog();
                }).toThrowError();
                expect(function () {
                    tfsMethods.dialog.openSubmitPopup();
                }).toThrowError();
                expect(function () {
                    tfsMethods.dialog.closeSubmitPopup();
                }).toThrowError();
                expect(function () {
                    tfsMethods.toolbar.hideToolbar();
                }).toThrowError();
                expect(function () {
                    tfsMethods.browser.getName();
                }).toThrowError();
                expect(function () {
                    tfsMethods.browser.getBrowserVersion();
                }).toThrowError();
                expect(function () {
                    tfsMethods.browser.getDocumentMode();
                }).toThrowError();
            });
            ...
            describe('supported methods', function () {
                ...
                describe('tfsMethods.alert', function () {
                    ...
                    beforeAll(function () {
                        ...
                        getResolveDialogPromise = function getResolveDialogPromise() {
                            var defer = Q.defer();
                            defer.resolve();
