...
function (formExceptions, loadWSList, Q, entityBase, services) {//eslint-disable-line
        ...
        describe('getListByURL function - get list using govServiceList with free url and data', function () {
            ...
            beforeEach(function () {
                ...
                response = {
                    Data: {
                        Dictionary: [
                         { dataCode: 'ba170c77-84fa-e211-9bbe-005056b108a6', dataText: 'איווקו - 25S18' },
                         { dataCode: 'bc170c77-84fa-e211-9bbe-005056b108a6', dataText: 'איווקו - 35 C15D' }
                        ]
                    },
                    ResponseCode: 0,
