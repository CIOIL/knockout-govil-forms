...
define(['common/utilities/functionalPatterns'], function (functionalPatterns) {
    ...
    describe('once', function () {
        ...
        it('creatorFunction param is mandatory', function () {
            expect(function () {
                functionalPatterns.once();
            }).toThrow(new exceptions.FormError(exeptionMessages.invalidElementTypeParam));
        });
        ...
        it('should throw error where executing more than one', function () {
            ...
            expect(function () {
                createViewModel();
            }).toThrow(new exceptions.FormError(exeptionMessages.once));
        });
    });
});