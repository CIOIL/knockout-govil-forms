define(['common/resources/exeptionMessages', 'common/utilities/stringExtension', 'common/utilities/conversion'],
    function (exeptionMessages, stringExtension, conversion) {
        ...
        describe('keyValuePairsToObject', function () {
            ...
            it('should return object', function () {
                ...
                expect(typeof conversion.keyValuePairsToObject(keyValuePairs, ',', '-')).toEqual('object');
            });
        ...
        describe('jsonToKeyValuePair', function () {
            ...
            it('should return string', function () {
                expect(typeof conversion.jsonToKeyValuePair(inputObj, '-', ',')).toEqual('string');
            });
