define(['common/ko/validate/koValidationSpecMatchers',
    'common/utilities/stringExtension',
      'common/resources/texts/date',
      'common/utilities/hebrewDateMethods',
      'common/viewModels/languageViewModel',
      'common/ko/validate/extensionRules/hebrewDate',
      'common/ko/globals/multiLanguageObservable'
],

function (matchers, stringExtension, resources, hebrewDateMethods,languageViewModel) {//eslint-disable-line max-params
        ...
        describe('extensionRules HebrewDate', function () {
            describe('pastHebrewDate', function () {
                ...
                it('params is undefined', function () {
                    ...
                    expect(function () { testObj({ year: 5776, month: 7, day: 1 }); }).toThrow();
            ...
            describe('between2HebrewDates', function () {
                ...
                it('fromDate null', function () {
                    ...
                    expect(function () { testObj({ year: 5776, month: 6, day: 3 }); }).toThrow();
                });
                ...
                it('fromDate undefined', function () {
                    ...
                    expect(function () { testObj({ year: 5776, month: 6, day: 3 }); }).not.toThrow();
                });
