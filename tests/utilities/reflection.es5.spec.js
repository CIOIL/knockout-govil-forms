...
define(['common/resources/exeptionMessages', 'common/utilities/stringExtension', 'common/utilities/reflection'], function (exeptionMessages, stringExtension, commonReflection) {
    ...
    describe('extendSettingsWithDefaults', function () {
        ...
        describe('deep extend', function () {
            ...
            it('maintains computed field', function () {
                var inTheCity = ko.computed(function () {
                    return true;
                });
                var target = { name: 'Avi', lastName: 'Levi', address: { street: 'Bar Ilan', city: 'Jerusalem' } };
