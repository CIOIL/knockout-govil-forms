define(['common/utilities/fileViewer',
        'common/utilities/userBrowser'
], function (fileViewer, userBrowser) {
    describe('downloadFileByBlob', function () {
        ...
        describe('params', function () {
            it('undefined', function () {
                expect(function () { fileViewer.downloadFileByBlob(); }).toThrowError();
            });
            it('fileName should be string', function () {
                expect(function () { fileViewer.downloadFileByBlob(1); }).toThrowError();
            });
            it('content parameter is mandatory', function () {
                expect(function () { fileViewer.downloadFileByBlob(fileName); }).toThrowError();
            });
            it('type parameter is optional', function () {
                expect(function () { fileViewer.downloadFileByBlob(fileName, {}); }).not.toThrowError();
            });
