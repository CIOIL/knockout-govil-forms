define(['common/mapping/viewModelMapper', 'common/elements/dynamicTable', 'common/viewModels/ModularViewModel', 'common/ko/bindingHandlers/checkbox', 'common/ko/bindingHandlers/tlpLookUp', 'common/ko/bindingHandlers/attachment', 'common/entities/entityBase', 'common/ko/fn/config'], function (viewModelMapper, dynamicTable, ModularViewModel, checkbox, tlpLookUp, attachment, entityBase) {
    ...
    describe('view Model Mapper', function () {
        ...
        var testingObjects = function testingObjects() {

            var dataModel = function dataModel(args) {
                ...
                var statusList = [{ key: '1', value: 'נשוי' }, { key: '2', value: 'גרוש' }, { key: '3', value: 'אלמן' }, { key: '4', value: 'רווק' }];
            ...
            var listDataModel = function listDataModel(args) {
                var model = {
            ...
            var nestedListWithoutMapSettingsDataModel = function nestedListWithoutMapSettingsDataModel() {
                var model = {
                    outerList: ko.observableArray([new listDataModel()]).config({ type: listDataModel })
                };
        ...
        var xml;
        var newMappingRule;
        var initializationTestingObjects = function initializationTestingObjects() {
        ...
        beforeAll(function () {
            ...
            newMappingRule = {
                condition: function condition(property) {
                    return property.newMappingRule;
                },
                map: function map(source, destination) {
