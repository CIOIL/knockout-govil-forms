    ...
    describe('attachment methods', function () {
        ...
        describe('getWrapperElement function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.getWrapperElement(attachment1); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.getWrapperElement(regularInput); }).toThrowError(invalidTypeTitle);
            });
        });
        ...
        describe('getCoverElement function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.getCoverElement(attachment1); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.getCoverElement(regularInput); }).toThrowError(invalidTypeTitle);
            });
        });
        ...
        describe('isAttachment function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.isAttachment(attachment1); }).toThrowError(undefinedElementTitle);
            });
        });
        ...
        describe('isAttachmentInTable function', function () {
            ...
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.isAttachmentInTable(regularInput); }).toThrowError(invalidTypeTitle);
            });
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.isAttachmentInTable(attachment1); }).toThrowError(undefinedElementTitle);
            });
        });
        ...
        describe('getAttachmentIndexInTable function', function () {
            ...
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.getAttachmentIndexInTable(regularInput); }).toThrowError(invalidTypeTitle);
            });
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.getAttachmentIndexInTable(attachment1); }).toThrowError(undefinedElementTitle);
            });
        });
        ...
        describe('getAttachmentsUniqueNames function', function () {
            ...
            it('invalid data - not a table', function () {
                expect(function () { attachmentMethods.getAttachmentsUniqueNames(attachment, true); }).toThrowError('the parameter "element" must be of table of attachments element type');
            });

            it('undefined element parameter - call with unexisting element', function () {
                var tableElement = $('#attachmentsTable1');
                expect(function () { attachmentMethods.getAttachmentsUniqueNames(tableElement, true); }).toThrowError(undefinedElementTitle);
            });

            it('invalid "isTable" parameter', function () {
                attachmentsTable.data('newfilenames', ['attachment1', 'attachment2']);
                expect(function () { attachmentMethods.getAttachmentsUniqueNames(attachmentsTable, 'vv'); }).toThrowError(invalidTypeTitle);
                attachmentsTable.removeData('newfilenames');
            });
            ...
            it('valid data - attachment input', function () {
                attachment.data('newfilename', 'attachment1');
                expect(function () { attachmentMethods.getAttachmentsUniqueNames(attachmentsTable, false); }).toThrowError(invalidTypeTitle);
            });
        ...
        describe('getFileSizeAttr function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.getFileSizeAttr(attachment1); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
        ...
        describe('getClosestTable function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.getClosestTable(attachment1); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.getClosestTable(regularInput); }).toThrowError(invalidTypeTitle);
            });
        });
        ...
        describe('getExtensions function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.getExtensions(attachment1); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.getExtensions(regularInput); }).toThrowError(invalidTypeTitle);
            });
        });
        ...
        describe('hasImgTFSAction function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.hasImgTFSAction(attachment1); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.hasImgTFSAction(regularInput); }).toThrowError(invalidTypeTitle);
            });
        });
        ...
        describe('getImg function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.getImg(attachment1); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.getImg(regularInput).is('img'); }).toThrowError(invalidTypeTitle);
            });
        });
        ...
        describe('getLabelElement function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { $(attachmentMethods.getLabelElement(attachment1)); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
                expect(function () { $(attachmentMethods.getLabelElement(regularInput)).is('label'); }).toThrowError(invalidTypeTitle);
            });
        });
        ...
        describe('getLinkElement function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { attachmentMethods.getLinkElement(attachment1); }).toThrowError(undefinedElementTitle);
            });
            it('call with not a attachment element', function () {
                expect(function () { attachmentMethods.getLinkElement(regularInput).is('a'); }).toThrowError(invalidTypeTitle);
            });
        });
