    ...
    function  //eslint-disable-line max-params
        ...
        describe('Dynamic table', function () {
            ...
            it('should include texts resources', function () {
                expect(typeof dynamicTable.texts).toEqual('object');
            });

            it('should include events names', function () {
                expect(typeof dynamicTable.events).toEqual('object');
            });
            ...
            describe('add row', function () {
                ...
                it('not to throw when model is defined', function () {
                    ...
                    expect(function () {
                        ko.bindingHandlers.addRow.init($('#addRow')[0], viewModel.contactsList, function () { return {}; });
                    }).not.toThrow();
                });
                ...
                describe('max rows', function () {
                    ...
                    it('max rows from config can be observable/computed', function (done) {
                        viewModel.contactsList = ko.observableArray([new Person()]).config({ type: Person, maxRows: ko.computed(function () { return 2; }) });
                ...
                describe('params', function () {
                    ...
                    it('params unwrapped if subscribable', function (done) {
                        ...
                        $('#addRowMax').click();
                        setTimeout(function () {
                            expect(typeof viewModel.contactsList()[0].settings).toEqual('function');
                            done();
                        }, delay);
                    });
                });
            ...
            describe('mapping', function () {
                ...
                it('array param are mandatory', function () {
                    expect(function () { dynamicTable.createMappingRules(); }).toThrowError(stringExtension.format(exeptionMessages.invalidElementTypeParam, 'array', 'observableArray'));
                });

                it('array param must vave a type on configuration of table', function () {
                    var array = ko.observableArray();
                    expect(function () { dynamicTable.createMappingRules(array); }).toThrowError();
                });
