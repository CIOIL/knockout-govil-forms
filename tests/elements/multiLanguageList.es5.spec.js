...
define(['common/elements/multiLanguageList', 'common/utilities/loadWSList', 'common/external/q', 'common/viewModels/languageViewModel', 'common/infrastructureFacade/tfsMethods'], function (multiLanguageList, loadWSList, Q, languageViewModel, tfsMethods) {
    //eslint-disable-line
    ...
    describe('multi Language List', function () {
        ...
        describe('languageEntity', function () {
            ...
            it('to be defined', function () {
                expect(_typeof(multiLanguageList.LanguageEntity)).toBeDefined();
            ...
            it('create languageEntity without paramters not failed', function () {
                expect(function () {
                    new multiLanguageList.LanguageEntity();
                }).not.toThrow();
            });
        ...
        describe('ViewModel', function () {
            ...
            it('to be defined', function () {
                expect(_typeof(multiLanguageList.ViewModel)).toBeDefined();
            });
        ...
        describe('createBindListSettings function', function () {
            ...
            it('to be function', function () {
                expect(_typeof(multiLanguageList.createBindListSettings)).toBe('function');
            });
            it('createBindListSettings return bindSettings and list', function () {
                expect(_typeof(bindSettingsList.bindSettings)).toBe('object');
                expect(_typeof(bindSettingsList.list)).toBe('function');
            });
            it('call createBindListSettings without paramters fail', function () {
                expect(function () {
                    multiLanguageList.createBindListSettings();
                }).not.toThrow();
            });
