    ...
    describe('lookup methods in AGForms', function () {
        ...
        describe('"hasLookupValue" function', function () {
            ...
            it('call with not a lookup element', function () {
                expect(function () { lookUpMethods.hasLookupValue(regularInput); }).toThrowError('the parameter "element" must be of LookUpWindow type');
            });
            it('call with not a lookup element in the same div of lookup', function () {
                expect(function () { lookUpMethods.hasLookupValue(regularInputInDiv); }).toThrowError('the parameter "element" must be of LookUpWindow type');
            });
        ...
        describe('"getLookupValue" function', function () {
            ...
            it('call with not a lookup element', function () {
                expect(function () { lookUpMethods.getLookupValue(regularInput); }).toThrowError('the parameter "element" must be of LookUpWindow type');
            });
            it('call with not a lookup element in the same div of lookup', function () {
                expect(function () { lookUpMethods.getLookupValue(regularInputInDiv); }).toThrowError('the parameter "element" must be of LookUpWindow type');
            });
        ...
        describe('"getSelectElement" function', function () {
            ...
            it('call with undefined element', function () {
                expect(function () { lookUpMethods.getSelectElement(undefinedTown); }).toThrowError('the parameter "element" is undefined');
            });

            it('call with not a lookup element', function () {
                expect(function () { lookUpMethods.getSelectElement(regularInput); }).toThrowError('the parameter "element" must be of LookUpWindow type');
            });
            it('call with not a lookup element in the same div of lookup', function () {
                expect(function () { lookUpMethods.getSelectElement(regularInputInDiv); }).toThrowError('the parameter "element" must be of LookUpWindow type');
            });
        });
        ...
        describe('"getArrowElement" function', function () {
            ...
            it('call with not a lookup element', function () {
                expect(function () { lookUpMethods.getArrowElement(regularInput); }).toThrowError('the parameter "element" must be of LookUpWindow type');
            });
            it('call with not a lookup element in the same div of lookup', function () {
                expect(function () { lookUpMethods.getArrowElement(regularInputInDiv); }).toThrowError('the parameter "element" must be of LookUpWindow type');
            });
        });
        ...
        describe('"getLabelElement" function', function () {
            ...
            it('call with not a lookup element', function () {
                expect(function () { $(lookUpMethods.getLabelElement(regularInput)); }).toThrowError();
            });
            it('call with not a lookup element in the same div of lookup', function () {
                expect(function () { $(lookUpMethods.getLabelElement(regularInputInDiv)).is('label'); }).toThrowError();
            });
        });
