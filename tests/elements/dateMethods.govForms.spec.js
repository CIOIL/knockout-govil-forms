define(['common/elements/dateMethods', 'common/external/jquery-ui', 'common/ko/bindingHandlers/tlpDatepicker'],
    ...
    describe('govForms - date methods', function () {
        ...
        describe('getButtonElement function', function () {
            ...
            it('call with not a date element', function () {
                expect(function () { dateMethods.getButtonElement($('#regularInput')); }).toThrowError('the parameter "element" must have tlpDatepicker binding');
            });
            it('call with not a date element in the same div of date', function () {
                expect(function () { dateMethods.getButtonElement($('#regularInputInDiv')); }).toThrowError('the parameter "element" must have tlpDatepicker binding');
            });
